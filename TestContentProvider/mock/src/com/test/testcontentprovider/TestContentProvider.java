...
public class TestContentProvider extends ContentProvider{
    ...
    private static final String TAG = "MOCKTestContentProvider";
...
//    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        MatrixCursor c = new MatrixCursor(new String[] {TableMetaData._ID, TableMetaData.NAME, TableMetaData.AGE, TableMetaData.PHONE_NUMBER});
        
        // same for all queries
        c.addRow(new Object[] { 1, "Chicken Sandwich", 0, "999" });
        c.addRow(new Object[] { 2, "Toast", 2, "987" });
        c.addRow(new Object[] { 3, "Soup", 2, "654" });
