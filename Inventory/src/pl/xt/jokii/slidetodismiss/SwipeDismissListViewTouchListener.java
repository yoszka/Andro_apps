...
package pl.xt.jokii.slidetodismiss;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                mCurrentItem = child;
                // "category" view aren't dismissable
                if(child == null || child.getTag() == null){	// "category" view haven't tag
                	return true;
                }
                // If item is dismissed then  isn't dismissable any more
                if(mCurrentItem.findViewById(R.id.list_item_content_layout).getVisibility() == View.GONE){
                	return true;
                }
