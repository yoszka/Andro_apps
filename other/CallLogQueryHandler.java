...
/*package*/ class CallLogQueryHandler extends AsyncQueryHandler {
    ...
    Object progressBarSynchroinzator = new Object();
...
//        Toast.makeText(mContext, "fetchVoicemailStatus " + QUERY_VOICEMAIL_STATUS_TOKEN, Toast.LENGTH_SHORT).show();
...
//        Toast.makeText(mContext, "fetchCalls " + token, Toast.LENGTH_SHORT).show();
